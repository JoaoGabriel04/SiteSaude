        ...
        <section className="w-full h-full px-4 pt-4 pb-2 bg-zinc-300/50 overflow-y-auto rounded-sm md:shadow-[0px_0px_4px_#00000060]">
          ...
          <Carousel className="w-full mt-4">
            <CarouselContent className="-ml-4">
              ...
              {/* Minhas Consultas Hoje — só MÉDICO */}
              {isMedico && (
                <CarouselItem className="pl-4 basis-2/3 md:basis-1/4 lg:basis-1/6">
                  <StatCard
              ...
              {/* Pacientes Atendidos no Mês — só MÉDICO */}
              {isMedico && (
                <CarouselItem className="pl-4 basis-2/3 md:basis-1/4 lg:basis-1/6">
                  <StatCard
          ...
          {/* CONTEÚDO PRINCIPAL: Agendamentos + Médicos */}
